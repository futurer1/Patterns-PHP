...
$obj1 = Preferences::getInstance();    //получаем ссылку на ранее существующий объект
echo $obj1->getProperty("Status");    //выводим значение элемена массива по ключу
                                      //убеждаемся таким образом, что данные внутри объекта сохранились
?>
